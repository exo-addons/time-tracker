        ...
        <div>
            <v-form ref="form" v-model="valid">
                ...
                <v-row>
                    ...
                    <v-autocomplete v-model="teamIds" :items="teams" outlined dense chips small-chips multiple menu-props="closeOnClick" item-text="name" item-value="id"></v-autocomplete>
                </v-row>
