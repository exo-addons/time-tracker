<template>
<exo-drawer ref="editSubActivityCodeDrawer" right class="">
    <template slot="title">
        Add SubActivityCode
    </template>
        ...
        <div>
            <v-form ref="form" v-model="valid">
                <v-row>
                    ...
                    <input ref="code" v-model="subActivityCode.code" type="text" name="code" class="input-block-level ignore-vuetify-classes my-3" />
                </v-row>
