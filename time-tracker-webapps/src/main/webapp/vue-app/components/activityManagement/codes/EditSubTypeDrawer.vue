<template>
<exo-drawer ref="editSubTypeDrawer" right class="">
    <template slot="title">
        Add SubType
    </template>
        ...
        <div>
            <v-form ref="form" v-model="valid">
                ...
                <v-row>
                    ...
                    <input ref="label" v-model="subType.label" type="text" name="label" class="input-block-level ignore-vuetify-classes my-3" />
                </v-row>
                <v-row>
                    <v-label for="type">
                        Type
